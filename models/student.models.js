...
Student.updateClass = (id, user, result) => {
  portalConnection.query(
    `UPDATE StudentLevel SET ? WHERE idStudentLevel = ${id}`,
    user,
    (err, res) => {
      if (err) {
